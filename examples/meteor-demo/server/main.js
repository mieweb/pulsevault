...
const workspaceDir =
  process.env.PULSEVAULT_DIR || path.join(os.tmpdir(), 'pulsevault-meteor-demo-data');
...
Meteor.startup(() => {
  console.log(
    `PulseVault Meteor demo — pulsevault mounted at /pulsevault, workspaceDir=${workspaceDir}`,
  );
  if (DEMO_TOKEN) {
